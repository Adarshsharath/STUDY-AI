    ...
    <div className="h-full bg-gray-950 overflow-y-auto">
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="glass-morphism rounded-2xl p-8 mb-8">
          <label
            htmlFor="file-upload"
            className={`flex flex-col items-center justify-center border-2 border-dashed border-white/20 rounded-xl p-12 cursor-pointer transition-all ${
              uploading ? 'opacity-50 cursor-not-allowed' : 'hover:border-primary-500/50 hover:bg-white/5'
            }`}
          >
          ...
          {uploadProgress && (
            <div className={`mt-4 p-4 rounded-xl flex items-center justify-between ${
              uploadProgress.status === 'success' ? 'bg-green-500/10 border border-green-500/50' :
